...
def config_parser():
    ...
    config_parser.add_argument("--hana-qslverify", help="Validate the HANA certificate (default=False)", default=False, action="store_true")
    ...
    space_list_parser.add_argument("-o", "--objects",   help="extend search to include database user schema objects (slower)", default=False, action="store_true")
    ...
    space_member_add_parser.add_argument("-q", "--query", help="use search lookup for users", default=False, action="store_true")
    ...
    conn_list_parser.add_argument("-q", "--query",      help="Use search lookup for space name (default=false)", action="store_true")
    ...
    conn_list_parser.add_argument("spaceID",            help="space(s) to list connections", nargs='+')
    ...
    share_create_parser.add_argument("-q", "--query", help="Use search lookup for space name (default=false)", action="store_true")
